...
export const zh_CN: TranslationMap = {
  ...
  nodes: {
    ...
    approvals: {
      ...
      loadHint: "加载 exec 审批后即可编辑允许列表。",
      target: "目标",
      targetSubtitle: "Gateway 编辑本地审批；node 编辑所选节点。",
      host: "主机",
      gateway: "Gateway",
      node: "节点",
      selectNode: "选择节点",
      noNodesYet: "尚无节点声明支持 exec 审批。",
      scope: "范围",
      defaults: "默认值",
      security: "安全策略",
  ...
  instances: {
    ...
    reason: "原因 {reason}",
    unknownHost: "未知主机",
    scopeCount: "{count} 个作用域",
    scopesList: "作用域：{value}",
  },
  debug: {
    snapshotsTitle: "快照",
    snapshotsSubtitle: "状态、健康度和心跳数据。",
    status: "状态",
    health: "健康度",
    lastHeartbeat: "最近心跳",
    securityAuditLead: "安全审计：",
    criticalSummary: "{count} 个严重问题",
    warningsSummary: "{count} 个警告",
    noCriticalIssues: "没有严重问题",
    infoSummary: " · {count} 条信息",
    runForDetails: "运行",
    forDetails: "查看详情。",
    manualRpcTitle: "手动 RPC",
    manualRpcSubtitle: "发送带 JSON 参数的原始网关方法。",
    method: "方法",
    selectMethod: "选择一个方法…",
    paramsJson: "参数（JSON）",
    modelsTitle: "模型",
  ...
  ui: {
    ...
    config: {
      ...
      schemaUnavailableUseRaw: "Schema 不可用。请使用原始模式。",
