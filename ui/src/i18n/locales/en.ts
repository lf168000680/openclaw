...
export const en: TranslationMap = {
  ...
  nodes: {
    ...
    approvals: {
      ...
      autoAllowSkillClisDefault: "Allow skill executables listed by the Gateway.",
      usingDefault: "Using default ({value}).",
      overrideState: "Override ({value}).",
      on: "on",
      off: "off",
  ...
  debug: {
    ...
    securityAuditLead: "Security audit:",
    criticalSummary: "{count} critical",
    warningsSummary: "{count} warnings",
    noCriticalIssues: "No critical issues",
    infoSummary: " · {count} info",
    runForDetails: "Run",
