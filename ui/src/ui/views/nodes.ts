    ...
    <section class="card">
      ...
      <div class="list" style="margin-top: 16px;">
        ...
        ${pending.length === 0 && paired.length === 0
          ? html` <div class="muted">${t("nodes.devices.noPairedDevices")}</div> `
          : nothing}
      </div>
    </section>
  `;
...
function renderTokenRow(deviceId: string, token: DeviceTokenSummary, props: NodesProps) {
  const status = token.revokedAtMs ? t("nodes.devices.revoked") : t("common.active");
            ...
            <div class="list" style="margin-top: 16px;">
              <div class="list-item">
                ...
                <div class="list-meta">
                  ...
                  ${!supportsBinding
                    ? html` <div class="muted">${t("nodes.binding.noNodesWithSystemRun")}</div> `
                    : nothing}
                </div>
              </div>

              ${state.agents.length === 0
                ? html` <div class="muted">${t("nodes.binding.noAgentsFound")}</div> `
      ...
      <div class="list-main">
        ...
        <div class="list-sub">
          ...
          ${bindingValue === "__default__"
            ...
            : t("nodes.binding.override", { value: String(agent.binding) })}
        </div>
      </div>
      <div class="list-meta">
        <label class="field">
